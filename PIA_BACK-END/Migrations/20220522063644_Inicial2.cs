...
namespace PIA_BACK_END.Migrations
{
    /// <inheritdoc />
    public partial class Inicial2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "rifaParticipante",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    idParticipante = table.Column<int>(type: "int", nullable: false),
                    idDeRifa = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_rifaParticipante", x => x.Id);
                    table.ForeignKey(
                        name: "FK_rifaParticipante_participantes_participanteId",
                        column: x => x.participanteId,
                        principalTable: "participantes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_rifaParticipante_rifas_RifaId",
                        column: x => x.RifaId,
                        principalTable: "rifas",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_rifaParticipante_participanteId",
                table: "rifaParticipante",
                column: "participanteId");

            migrationBuilder.CreateIndex(
                name: "IX_rifaParticipante_RifaId",
                table: "rifaParticipante",
                column: "RifaId");
        }
